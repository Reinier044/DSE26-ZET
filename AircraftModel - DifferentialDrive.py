...
#Variables
DesAccel        = 0.4905        #[m/s^2]Desired acceleration
Rvw             = Rmlg          #[m] Radius Vehicle Wheel
MLGTugW         = 10180         #[kg] estimated tug weight
NGTugW          = 000           #[kg] estimated nose gear tug weight
...
MaxPower        = 515           #[kW] Selected engine MaxPower
AvgPower        = 56.18         #[kW] Selected engine average Power
EngineRPM       = 1790          #RPM for selected engine
NumCycles       = 20
...
print("Total energy needed for taxi: ",NumEngines*Energy/1000, "[mJ]")
